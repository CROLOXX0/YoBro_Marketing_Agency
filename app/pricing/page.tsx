...
<div className="bg-surface-container rounded-xl p-6 md:p-8 flex flex-col relative transform lg:-translate-y-4 shadow-[0_0_30px_rgba(255,146,28,0.2)] border-2 border-primary/80">
