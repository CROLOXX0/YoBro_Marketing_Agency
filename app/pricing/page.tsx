...
<section className="py-section-padding text-center relative reveal">
...
<section className="mb-section-padding relative z-10 reveal">
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter">

<div className="bg-surface-container border border-glass-stroke rounded-xl p-8 flex flex-col hover:-translate-y-2 hover:shadow-[0_0_20px_rgba(255,146,28,0.1)] transition-all duration-300 relative">
...
<div className="text-4xl font-extrabold text-primary mb-8">
  {isDiscountActive ? (
    <>
      <span className="line-through text-on-surface-variant text-2xl mr-2">Rs-{pricing.trial.price.toLocaleString()}</span>
...
<div className="text-4xl font-extrabold text-primary mb-8">
  {isDiscountActive ? (
    <>
      <span className="line-through text-on-surface-variant text-2xl mr-2">Rs-{pricing.starter.price.toLocaleString()}</span>
...
<div className="bg-surface-container rounded-xl p-8 flex flex-col relative transform lg:-translate-y-4 shadow-[0_0_30px_rgba(255,146,28,0.2)] border-2 border-primary/80">
...
<div className="text-4xl font-extrabold text-primary mb-8">
  {isDiscountActive ? (
    <>
      <span className="line-through text-on-surface-variant text-2xl mr-2">Rs-{pricing.growth.price.toLocaleString()}</span>
...
<div className="text-4xl font-extrabold text-primary mb-8">
  {isDiscountActive ? (
    <>
      <span className="line-through text-on-surface-variant text-2xl mr-2">Rs-{pricing.premium.price.toLocaleString()}</span>
...
<section className="py-section-padding reveal">
...
<div className="glass-panel p-10 rounded-xl flex items-start gap-6">
